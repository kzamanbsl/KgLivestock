...
namespace Firm.Service.Services.FeedConsumptionCowWise_Services
{
    public class FeedConsumptionCowWiseService : IFeedConsumptionCowWiseService
    {
        ...
        {
            //bool isExists = await context.FeedConsumptionCowWises.AnyAsync(c => c.FeedCategoryName == model.FeedCategoryName && c.Id != model.Id);
            //if (isExists)
            //{
            //    model.ErrorMessage = "FeedConsumptionCowWise already exists. Please add another Phone Number.";
            //    return model;
            //}
